...
void ChassisTankDriveCommand::execute(){
    float limitedLeftVelocity = limitVal<float>(operatorInterface.getChassisTankLeftInput() * MAX_CHASSIS_SPEED_MPS, -MAX_CHASSIS_SPEED_MPS, MAX_CHASSIS_SPEED_MPS);
    float limitedRightVelocity = limitVal<float>(operatorInterface.getChassisTankRightInput() * MAX_CHASSIS_SPEED_MPS, -MAX_CHASSIS_SPEED_MPS, MAX_CHASSIS_SPEED_MPS);
    chassis.setVelocityTankDrive(limitedLeftVelocity, limitedRightVelocity);
}
